...
#iptables -A INPUT -p tcp --dport ${ComPort} -m conntrack --ctstate NEW,ESTABLISHED -j ACCEPT
#iptables -A OUTPUT -p tcp --sport ${ComPort} -m conntrack --ctstate ESTABLISHED -j ACCEPT

iptables -F #Acertar o iptables
